...
This is the new electron GUI for MonetaVerde. It is open source and completely free to use without restrictions, anyone may create an alternative implementation of the MonetaVerde Electron GUI that uses the protocol and network in a compatible manner.
