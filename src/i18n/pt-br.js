export default {
    ...
    menuItems: {
        ...
        exit: "Saír da Carteira GUI MonetaVerde",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "monetaverded não encontrado, utilizando nódulo remoto"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        monetaverdeUnlockedBalance: "Saldo desbloqueado",
        monetaverdeUnlockedShort: "Desbloqueado",
