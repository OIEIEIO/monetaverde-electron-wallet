export default {
    ...
    menuItems: {
        ...
        exit: "Quitter le portefeuille MonetaVerde GUI",
    ...
    notification: {
        ...
        warnings: {
            ...
            usingRemoteNode: "monetaverded introuvable, utilisation du nœud distant"
        }
    },
    placeholders: {
    ...
    strings: {
        ...
        monetaverdeBalance: "Solde",
        monetaverdeExchangeBalance: "Solde",
        monetaverdeUnlockedBalance: "Solde débloqué",
        monetaverdeUnlockedShort: "Débloqué",
