...
<div class="check-transaction">
    <div class="q-pa-md">
        ...
        <div>
            <MonetaVerdeField :label="$t('fieldLabels.transactionId')" :error="$v.txid.$error">
            ...
            <MonetaVerdeField class="q-mt-md" :label="$t('fieldLabels.address')" :error="$v.address.$error" optional>
            ...
            <MonetaVerdeField class="q-mt-md" :label="$t('fieldLabels.message')" optional>
            ...
            <MonetaVerdeField class="q-mt-md" :label="$t('fieldLabels.signature')" :error="$v.signature.$error">
        ...
        <div v-if="status.state.txid">
            ...
            <div class="q-mb-sm" v-if="status.state.received != null">
                ...
                <div><FormatMonetaVerde :amount="status.state.received" raw-value /></div>
            </div>
