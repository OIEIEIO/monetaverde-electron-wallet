<template>
<q-list class="monetaverde-list-item" no-border @click.native="details(address)">
    <q-item>
        <q-item-main>
    ...
    <template v-if="shouldShowInfo">
        ...
        <q-item class="info">
            <q-item-main class="flex justify-between">
                <div class="column">
                    <span>{{ $t("strings.monetaverdeBalance") }}</span>
                    <span class="value">{{address.balance | currency}}</span>
                </div>
                <div class="column">
                    <span>{{ $t("strings.monetaverdeUnlockedBalance") }}</span>
