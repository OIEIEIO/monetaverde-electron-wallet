...
<div class="service-node-staking">
    <div class="q-px-md q-pt-md">
        <MonetaVerdeField :label="$t('fieldLabels.serviceNodeKey')" :error="$v.service_node.key.$error">
        ...
        <MonetaVerdeField :label="$t('fieldLabels.amount')" class="q-mt-md" :error="$v.service_node.amount.$error">
