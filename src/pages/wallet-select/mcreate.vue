...
<q-page class="create">
    ...
    <MonetaVerdeField :label="$t('fieldLabels.walletName')" :error="$v.wallet.name.$error">
        <q-input
            v-model="wallet.name"
            @keyup.enter="create"
        ...
        <MonetaVerdeField :label="$t('fieldLabels.seedLanguage')">
            <q-select
        ...
        <MonetaVerdeField :label="$t('fieldLabels.password')" optional>
            <q-input
        ...
        <MonetaVerdeField :label="$t('fieldLabels.confirmPassword')">
            <q-input
        ...
        status: {
            handler(val, old){
                ...
                switch(this.status.code) {
                    ...
                    case 0:
                        this.$q.loading.hide()
                        this.$router.replace({ path: "/wallet-select/mcreated" });
                        break;
                    default:
                        this.$q.loading.hide()
                        this.$q.notify({
