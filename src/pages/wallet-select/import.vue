...
<q-page>
    <div class="q-mx-md import-wallet">
        ...
        <MonetaVerdeField :label="$t('fieldLabels.newWalletName')" :error="$v.wallet.name.$error">
            <q-input
                v-model="wallet.name"
        ...
        <MonetaVerdeField :label="$t('fieldLabels.walletFile')" disable-hover :error="$v.wallet.path.$error">
            <q-input
                v-model="wallet.path"
        ...
        <MonetaVerdeField :label="$t('fieldLabels.password')">
            <q-input
